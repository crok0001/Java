 ...
 * System.in : 실행된 운영체제의 console을 이횽해서 값을 입력받음.
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 	...
		 	출럭하려는 지시자(값)의 수만큼 필요한 값을 알려줘야함.
		...
		*/
		...
		/*
			...
			%5d, 1000 == [ ][1][0][0][0]
			%[-] : 전체 자시수가 지정된 경우 왼쪽으로 정렬하고 빈칸에 공백 출력
			%-5d : 1000 == [1][0][0][0][ ]
			%[0] : 전체자리수가 지정되어 있을 때 빈자리를 0으로 표현
			%05d, %-5d : 1000 == [0][1][0][0][0]
			%[.m] : 소수점아래 자리수를 지정. 잘리는 소수점자리는 반올림
			%.2f, 82.687 == 82.69
			%[,] : 정수의 자리수 지정
